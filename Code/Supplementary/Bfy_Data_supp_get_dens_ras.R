...
# Generate raster showing all locations with occurrence points
...
alldata <- terra::vect(XY, geom=c("decimalLongitude","decimalLatitude"), crs="epsg:4326") # Converts to point file and give CRS
