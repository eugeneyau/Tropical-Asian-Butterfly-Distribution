---
title: "SEA_Bfy_SDM"
author: "Eugene Yu Hin Yau, Toby Tsang Pak Nok, Adam Lee Kai Chi"
date: "2023-02-03"
...
Redundant for HPC users, but useful for PC users <-- **Can delete**
```{r}
y=1
a=1

Failed.list <- error.list <-list() #For listing errors for re-run, sometimes (Machine learning) algorithm (randomly) fail because unable to converge
Ensemble.Forecast.Failed.list <- list()
```
