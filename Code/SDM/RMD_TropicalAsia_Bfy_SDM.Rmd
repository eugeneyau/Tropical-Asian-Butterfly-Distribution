...
Setup working directory (the directory where your data is kept in)
...
Set file path of current climate files
...
"I can wait forever" - If you have only one species to run, you can use the built-in method to run the MyBiomodfun function in the simplest manner
