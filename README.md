...
# 📰 News
* **June 2026**: Released occurrence dataset v1.1 (Occurrence Records of Tropical Asian Butterflies: 1970-2024 v1.1) that addresses multiple taxonomic errors identified in the GBIF records in our original dataset, which stemmed from issues with taxonomic harmonization and incorporates 17,635 GBIF records omitted from v1. See detailed description [`here`](https://github.com/eugeneyau/Tropical-Asian-Butterfly-Distribution/blob/main/Version%201.1%20update/readme.md).
